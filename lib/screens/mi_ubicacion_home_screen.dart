...
class MiUbicacionHomeScreen extends StatefulWidget {
  @override
  _MiUbicacionHomeScreenState createState() => _MiUbicacionHomeScreenState();
}

class _MiUbicacionHomeScreenState extends State<MiUbicacionHomeScreen> {
